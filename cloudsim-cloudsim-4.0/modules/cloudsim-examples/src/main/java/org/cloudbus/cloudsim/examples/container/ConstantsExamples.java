...
public class ConstantsExamples {
     ...
     */
    public static final double CONTAINER_STARTTUP_DELAY = 100;//the amount is in seconds
    ...
    //Variables del Entorno de Simulación	
    public static final int NUMBER_HOSTS = 80;// [1-250 Hosts]
    public static final int NUMBER_VMS = 100;//[1-Máquinas Virtuales Hosts]
    public static final int NUMBER_CLOUDLETS = 200;//[1-250 Cloudlets]
    public static final double VM_STARTTUP_DELAY = 555555;//the amoun is in seconds
